...
{
    public partial class salesmanForm : MetroFramework.Forms.MetroForm
    {
        public salesmanForm()
        {
            InitializeComponent();
            ...
            MyClassDataContext m = new MyClassDataContext(@"Data Source=(LocalDB)\v11.0;AttachDbFilename=D:\C# project\shop_management\shop_management.Data\shop.mdf;Integrated Security=True;Connect Timeout=30");
        ...
        {
            // TODO: This line of code loads data into the 'shopDataSet.Transaction' table. You can move, or remove it, as needed.
            this.transactionTableAdapter.Fill(this.shopDataSet.Transaction);
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            //        DataRow row = ss.NewRow();
            //        row["Date"] = Convert.ToString(sc.ProductName);
            //        row["Time"] = Convert.ToString(sc.ProductQuantity);
            //        row["Price"] = Convert.ToString(sc.ProductPrice);
            //        ss.Rows.Add(row);
            //        DateTime datetime = DateTime.Now;
            //        foreach (DataRow Drow in ss.Rows)           //Drow is datarow
            //        {
            //            int num = dataGridViewsales.Rows.Add();

            //            dataGridViewsales.Rows[num].Cells[0].Value = Drow["Date"].ToString();
            //            dataGridViewsales.Rows[num].Cells[1].Value = Drow["Time"].ToString();
            //            dataGridViewsales.Rows[num].Cells[2].Value = Drow["Price"].ToString();

            //        }

            //    //    dataGridView2.SelectAll();

            //        DatabaseAccess.Price = Convert.ToDouble(textBox3.Text);

            //        dataGridViewsales.Rows.Add(DatabaseAccess.Price);
